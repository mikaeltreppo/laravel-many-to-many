            ...
            @foreach ($project as $proj)
                <tr>
                    ...
                    <td>
                      ...
                      <span class="badge rounded-pill text-bg-success text-uppercase m-2">{{ $tech->name }}</span> 
                      @endforeach
                  </td>
                    <td>
                        <a href="{{ route('admin.projects.show', ['project' => $proj->id]) }}"
                            class="btn btn-outline-primary m-2">Apri</a>
                        <a href="{{ route('admin.projects.edit', ['project' => $proj->id]) }}"
                            class="btn btn-outline-warning m-2">Modifica</a>
